...
namespace System.Runtime.InteropServices
{
	...
	public interface _PropertyInfo
	{
		...
		/// <returns>One of the values in the following table.Value Meaning A <see cref="T:System.Reflection.MethodInfo" /> object representing the <see langword="Set" /> method for this property. The <see langword="set" /> accessor is public.-or- The <paramref name="nonPublic" /> parameter is <see langword="true" /> and the <see langword="set" /> accessor is non-public. 
		///             <see langword="null" />
		///           The <paramref name="nonPublic" /> parameter is <see langword="true" />, but the property is read-only.-or- The <paramref name="nonPublic" /> parameter is <see langword="false" /> and the <see langword="set" /> accessor is non-public.-or- There is no <see langword="set" /> accessor. </returns>
