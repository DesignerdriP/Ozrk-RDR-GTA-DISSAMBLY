...
namespace System
{
	...
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IValueTupleInternal, ITuple where TRest : struct
	{
		...
		// Token: 0x06000463 RID: 1123 RVA: 0x0000D260 File Offset: 0x0000B460
		...
		// Token: 0x06000464 RID: 1124 RVA: 0x0000D2C8 File Offset: 0x0000B4C8
		...
		// Token: 0x06000465 RID: 1125 RVA: 0x0000D2E0 File Offset: 0x0000B4E0
		...
		// Token: 0x06000466 RID: 1126 RVA: 0x0000D3B4 File Offset: 0x0000B5B4
		...
		// Token: 0x06000467 RID: 1127 RVA: 0x0000D4D0 File Offset: 0x0000B6D0
		...
		// Token: 0x06000468 RID: 1128 RVA: 0x0000D52C File Offset: 0x0000B72C
		...
		/// <exception cref="T:System.ArgumentException">
		///         <paramref name="other" /> is not a <see cref="T:System.ValueTuple`8" /> object. </exception>
		// Token: 0x06000469 RID: 1129 RVA: 0x0000D614 File Offset: 0x0000B814
		...
		// Token: 0x0600046B RID: 1131 RVA: 0x0000DA63 File Offset: 0x0000BC63
		...
		// Token: 0x0600046D RID: 1133 RVA: 0x0000DD86 File Offset: 0x0000BF86
		...
		// Token: 0x0600046F RID: 1135 RVA: 0x0000E1AC File Offset: 0x0000C3AC
		...
		// (get) Token: 0x06000470 RID: 1136 RVA: 0x0000E5B4 File Offset: 0x0000C7B4
		int ITuple.Length
		{
			get
			{
		...
		///   <paramref name="index" /> is less than 0.-or-<paramref name="index" /> is greater than or equal to <see cref="P:System.ValueTuple`8.System#Runtime#CompilerServices#ITuple#Length" />. </exception>
