...
namespace System.Collections.Concurrent
{
	...
	public class ConcurrentDictionary<TKey, TValue> : IDictionary<!0, !1>, ICollection<KeyValuePair<!0, !1>>, IEnumerable<KeyValuePair<!0, !1>>, IEnumerable, IDictionary, ICollection, IReadOnlyDictionary<!0, !1>, IReadOnlyCollection<KeyValuePair<TKey, TValue>>
	{
		...
		/// <param name="key">The key of the element to add.</param>
		/// <param name="valueFactory">The function used to generate a value for the key.</param>
		/// <param name="factoryArgument">An argument value to pass into <paramref name="name" />.</param>
		...
		/// 			key is already in the dictionary, or the new value for the key as returned by 
		...
		/// <typeparam name="TArg">
		/// 			  The type of the keys in this <see cref="T:System.Collections.Concurrent.ConcurrentDictionary`2" />
		/// 		  </typeparam>
		/// <returns>
