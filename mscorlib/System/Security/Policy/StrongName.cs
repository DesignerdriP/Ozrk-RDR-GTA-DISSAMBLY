...
namespace System.Security.Policy
{
	...
	public sealed class StrongName : EvidenceBase, IIdentityPermissionFactory, IDelayEvaluatedEvidence
	{
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="blob" /> parameter is <see langword="null" />.-or- The <paramref name="name" /> parameter is <see langword="null" />.-or- The <paramref name="version" /> parameter is <see langword="null" />. </exception>
