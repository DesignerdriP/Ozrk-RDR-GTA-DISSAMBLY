...
namespace System.Security.Policy
{
	...
	public sealed class StrongNameMembershipCondition : IMembershipCondition, ISecurityEncodable, ISecurityPolicyEncodable, IConstantMembershipCondition, IReportMatchMembershipCondition
	{
		...
		/// <exception cref="T:System.ArgumentException">The <paramref name="name" /> parameter is <see langword="null" />.-or-The <paramref name="name" /> parameter is an empty string ("").</exception>
		...
		/// <exception cref="T:System.ArgumentException">The value is <see langword="null" />.-or-The value is an empty string ("").</exception>
