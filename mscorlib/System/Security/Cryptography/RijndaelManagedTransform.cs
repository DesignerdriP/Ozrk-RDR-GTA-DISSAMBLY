...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x0600231D RID: 8989 RVA: 0x0007DEB0 File Offset: 0x0007C0B0
		...
		// Token: 0x0600231E RID: 8990 RVA: 0x0007E22B File Offset: 0x0007C42B
		public void Dispose()
		{
			this.Dispose(true);
		}
		...
		// Token: 0x0600231F RID: 8991 RVA: 0x0007E234 File Offset: 0x0007C434
		public void Clear()
		{
			this.Dispose(true);
		}

		// Token: 0x06002320 RID: 8992 RVA: 0x0007E240 File Offset: 0x0007C440
		...
		// (get) Token: 0x06002321 RID: 8993 RVA: 0x0007E325 File Offset: 0x0007C525
		...
		// (get) Token: 0x06002322 RID: 8994 RVA: 0x0007E32D File Offset: 0x0007C52D
		...
		// (get) Token: 0x06002323 RID: 8995 RVA: 0x0007E335 File Offset: 0x0007C535
		...
		// (get) Token: 0x06002324 RID: 8996 RVA: 0x0007E33D File Offset: 0x0007C53D
		...
		// (get) Token: 0x06002325 RID: 8997 RVA: 0x0007E340 File Offset: 0x0007C540
		...
		// Token: 0x06002326 RID: 8998 RVA: 0x0007E344 File Offset: 0x0007C544
		...
		// Token: 0x06002327 RID: 8999 RVA: 0x0007E4BC File Offset: 0x0007C6BC
		...
		// Token: 0x06002328 RID: 9000 RVA: 0x0007E5E0 File Offset: 0x0007C7E0
		public void Reset()
		{
			this.m_depadBuffer = null;
			if (this.m_cipherMode == CipherMode.CBC)
		...
		// Token: 0x06002329 RID: 9001 RVA: 0x0007E63C File Offset: 0x0007C83C
				...
				fixed (int* encryptKeyExpansion = this.m_encryptKeyExpansion)
				{
					fixed (int* ptr = RijndaelManagedTransform.s_T)
					{
						fixed (int* ptr2 = RijndaelManagedTransform.s_TF)
						{
							...
							checked
							{
								ptr3 = stackalloc int[unchecked((UIntPtr)this.m_Nb) * 4];
								ptr4 = stackalloc int[unchecked((UIntPtr)this.m_Nb) * 4];
							}
							...
							for (int j = 0; j < num4; j++)
							{
								if (this.m_cipherMode == CipherMode.CFB)
								{
									Buffer.Memcpy((byte*)ptr3, 0, this.m_shiftRegister, 0, this.m_blockSizeBytes);
								}
								else if (j != num4 - 1 || num == 0)
								{
									Buffer.Memcpy((byte*)ptr3, 0, inputBuffer, num3, this.m_blockSizeBytes);
								}
								else
								{
									int num6 = 0;
								...
								else
								{
									...
									if (this.m_cipherMode == CipherMode.CBC)
									{
										fixed (int* lastBlockBuffer = this.m_lastBlockBuffer)
										{
											Buffer.Memcpy((byte*)lastBlockBuffer, (byte*)ptr4, this.m_blockSizeBytes);
										}
									}
								}
		...
		// Token: 0x0600232A RID: 9002 RVA: 0x0007ECD8 File Offset: 0x0007CED8
		[SecuritySafeCritical]
								...
								fixed (int* ptr2 = RijndaelManagedTransform.s_TF)
								{
									fixed (int* ptr3 = RijndaelManagedTransform.s_iT)
									{
										fixed (int* ptr4 = RijndaelManagedTransform.s_iTF)
										{
											...
											checked
											{
												ptr5 = stackalloc int[unchecked((UIntPtr)this.m_Nb) * 4];
												ptr6 = stackalloc int[unchecked((UIntPtr)this.m_Nb) * 4];
		...
		// Token: 0x0600232B RID: 9003 RVA: 0x0007F3B4 File Offset: 0x0007D5B4
		[SecurityCritical]
		...
		// Token: 0x0600232C RID: 9004 RVA: 0x0007F5A4 File Offset: 0x0007D7A4
		[SecurityCritical]
		...
		// Token: 0x0600232D RID: 9005 RVA: 0x0007F7C0 File Offset: 0x0007D9C0
		...
		// Token: 0x0600232E RID: 9006 RVA: 0x0007FA95 File Offset: 0x0007DC95
		private static int rot1(int val)
		{
			return (val << 8 & -256) | (val >> 24 & 255);
		}

		// Token: 0x0600232F RID: 9007 RVA: 0x0007FAAB File Offset: 0x0007DCAB
		private static int rot2(int val)
		{
			return (val << 16 & -65536) | (val >> 16 & 65535);
		}

		// Token: 0x06002330 RID: 9008 RVA: 0x0007FAC2 File Offset: 0x0007DCC2
		private static int rot3(int val)
		{
			return (val << 24 & -16777216) | (val >> 8 & 16777215);
		}

		// Token: 0x06002331 RID: 9009 RVA: 0x0007FAD8 File Offset: 0x0007DCD8
		...
		// Token: 0x06002332 RID: 9010 RVA: 0x0007FB2C File Offset: 0x0007DD2C
