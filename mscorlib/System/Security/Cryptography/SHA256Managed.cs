...
namespace System.Security.Cryptography
{
	...
	public class SHA256Managed : SHA256
	{
		...
		// Token: 0x06002358 RID: 9048 RVA: 0x000805E0 File Offset: 0x0007E7E0
		...
		// Token: 0x06002359 RID: 9049 RVA: 0x00080650 File Offset: 0x0007E850
		...
		// Token: 0x0600235A RID: 9050 RVA: 0x0008069F File Offset: 0x0007E89F
		...
		// Token: 0x0600235B RID: 9051 RVA: 0x000806C4 File Offset: 0x0007E8C4
		...
		// Token: 0x0600235C RID: 9052 RVA: 0x000806F3 File Offset: 0x0007E8F3
		...
		// Token: 0x0600235D RID: 9053 RVA: 0x00080714 File Offset: 0x0007E914
		...
		// Token: 0x0600235E RID: 9054 RVA: 0x00080794 File Offset: 0x0007E994
		...
		// Token: 0x0600235F RID: 9055 RVA: 0x000808A8 File Offset: 0x0007EAA8
		...
		// Token: 0x06002360 RID: 9056 RVA: 0x00080994 File Offset: 0x0007EB94
		[SecurityCritical]
		...
		// Token: 0x06002361 RID: 9057 RVA: 0x00080CB1 File Offset: 0x0007EEB1
		private static uint RotateRight(uint x, int n)
		{
			return x >> n | x << 32 - n;
		}

		// Token: 0x06002362 RID: 9058 RVA: 0x00080CC3 File Offset: 0x0007EEC3
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x06002363 RID: 9059 RVA: 0x00080CCE File Offset: 0x0007EECE
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06002364 RID: 9060 RVA: 0x00080CDB File Offset: 0x0007EEDB
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ x >> 3;
		}

		// Token: 0x06002365 RID: 9061 RVA: 0x00080CF1 File Offset: 0x0007EEF1
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ x >> 10;
		}

		// Token: 0x06002366 RID: 9062 RVA: 0x00080D09 File Offset: 0x0007EF09
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x06002367 RID: 9063 RVA: 0x00080D24 File Offset: 0x0007EF24
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x06002368 RID: 9064 RVA: 0x00080D40 File Offset: 0x0007EF40
		[SecurityCritical]
