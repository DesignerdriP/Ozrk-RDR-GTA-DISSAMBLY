...
namespace System.Security.Permissions
{
	...
	public enum ReflectionPermissionFlag
	{
		...
		/// <summary>
		///     <see langword="TypeInformation" />
		///     , <see langword="MemberAccess" />, and <see langword="ReflectionEmit" /> are set. <see cref="F:System.Security.Permissions.ReflectionPermissionFlag.AllFlags" /> does not include <see cref="F:System.Security.Permissions.ReflectionPermissionFlag.RestrictedMemberAccess" />.</summary>
