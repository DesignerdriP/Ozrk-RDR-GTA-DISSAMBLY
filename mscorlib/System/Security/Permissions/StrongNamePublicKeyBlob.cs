...
namespace System.Security.Permissions
{
	...
	public sealed class StrongNamePublicKeyBlob
	{
		...
		/// <returns>
		///     <see langword="true" /> if the public key blob of the current object is equal to the public key blob of the <paramref name="obj" /> parameter; otherwise, <see langword="false" />.</returns>
