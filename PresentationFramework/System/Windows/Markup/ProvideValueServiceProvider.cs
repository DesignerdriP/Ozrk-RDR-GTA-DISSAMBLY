...
namespace System.Windows.Markup
{
	...
	{
		// Token: 0x0600220E RID: 8718 RVA: 0x000AA0CB File Offset: 0x000A82CB
		internal ProvideValueServiceProvider(ParserContext context)
		{
			this._context = context;
		}

		// Token: 0x0600220F RID: 8719 RVA: 0x0000326D File Offset: 0x0000146D
		internal ProvideValueServiceProvider()
		{
		}

		// Token: 0x06002210 RID: 8720 RVA: 0x000AA0DA File Offset: 0x000A82DA
		...
		// Token: 0x06002211 RID: 8721 RVA: 0x000AA0EC File Offset: 0x000A82EC
		internal void ClearData()
		{
			this._targetObject = (this._targetProperty = null);
		}

		// Token: 0x06002212 RID: 8722 RVA: 0x000AA109 File Offset: 0x000A8309
		...
		// (get) Token: 0x06002213 RID: 8723 RVA: 0x000AA123 File Offset: 0x000A8323
		...
		// (get) Token: 0x06002214 RID: 8724 RVA: 0x000AA12B File Offset: 0x000A832B
		...
		// (get) Token: 0x06002215 RID: 8725 RVA: 0x000AA133 File Offset: 0x000A8333
		// (set) Token: 0x06002216 RID: 8726 RVA: 0x000AA140 File Offset: 0x000A8340
		...
		// (get) Token: 0x06002217 RID: 8727 RVA: 0x000AA151 File Offset: 0x000A8351
		...
		// Token: 0x06002219 RID: 8729 RVA: 0x000AA16D File Offset: 0x000A836D
		Freezable IFreezeFreezables.TryGetFreezable(string value)
		{
			return this._context.TryGetFreezable(value);
		}

		// Token: 0x0600221A RID: 8730 RVA: 0x000AA17C File Offset: 0x000A837C
