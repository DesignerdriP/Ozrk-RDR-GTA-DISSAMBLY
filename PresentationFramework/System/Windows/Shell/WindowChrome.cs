...
namespace System.Windows.Shell
{
	...
	public class WindowChrome : Freezable
	{
		...
		private struct _SystemParameterBoundProperty
		{
			...
			// (get) Token: 0x06007EFF RID: 32511 RVA: 0x002371EE File Offset: 0x002353EE
			// (set) Token: 0x06007F00 RID: 32512 RVA: 0x002371F6 File Offset: 0x002353F6
			public string SystemParameterPropertyName { get; set; }

			// Token: 0x17001D8C RID: 7564
			// (get) Token: 0x06007F01 RID: 32513 RVA: 0x002371FF File Offset: 0x002353FF
			// (set) Token: 0x06007F02 RID: 32514 RVA: 0x00237207 File Offset: 0x00235407
