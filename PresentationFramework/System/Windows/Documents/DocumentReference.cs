...
namespace System.Windows.Documents
{
	...
	public sealed class DocumentReference : FrameworkElement, IUriContext
	{
		...
		// Token: 0x06002B55 RID: 11093 RVA: 0x000C6014 File Offset: 0x000C4214
		...
		// Token: 0x06002B58 RID: 11096 RVA: 0x000C6090 File Offset: 0x000C4290
		...
		// (get) Token: 0x06002B59 RID: 11097 RVA: 0x000C60DA File Offset: 0x000C42DA
		// (set) Token: 0x06002B5A RID: 11098 RVA: 0x000C60EC File Offset: 0x000C42EC
		public Uri Source
		{
			get
			{
		...
		// (get) Token: 0x06002B5B RID: 11099 RVA: 0x000C204F File Offset: 0x000C024F
		// (set) Token: 0x06002B5C RID: 11100 RVA: 0x000C2061 File Offset: 0x000C0261
		...
		// (get) Token: 0x06002B5D RID: 11101 RVA: 0x000C60FA File Offset: 0x000C42FA
		...
		// Token: 0x06002B5E RID: 11102 RVA: 0x000C6102 File Offset: 0x000C4302
		private void _Init()
		{
			base.InheritanceBehavior = InheritanceBehavior.SkipToAppNow;
		}

		// Token: 0x06002B5F RID: 11103 RVA: 0x000C610C File Offset: 0x000C430C
		[SecurityCritical]
		...
		// Token: 0x06002B60 RID: 11104 RVA: 0x000C6138 File Offset: 0x000C4338
		[SecurityCritical]
		[SecurityTreatAsSafe]
