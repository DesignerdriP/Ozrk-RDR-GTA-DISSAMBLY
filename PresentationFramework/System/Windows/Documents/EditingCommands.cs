...
namespace System.Windows.Documents
{
	...
	public static class EditingCommands
	{
		...
		// (get) Token: 0x06002C3F RID: 11327 RVA: 0x000C8E72 File Offset: 0x000C7072
		...
		// (get) Token: 0x06002C40 RID: 11328 RVA: 0x000C8E83 File Offset: 0x000C7083
		...
		// (get) Token: 0x06002C41 RID: 11329 RVA: 0x000C8E94 File Offset: 0x000C7094
		...
		// (get) Token: 0x06002C42 RID: 11330 RVA: 0x000C8EA5 File Offset: 0x000C70A5
		...
		// (get) Token: 0x06002C43 RID: 11331 RVA: 0x000C8EB6 File Offset: 0x000C70B6
		...
		// (get) Token: 0x06002C44 RID: 11332 RVA: 0x000C8EC7 File Offset: 0x000C70C7
		...
		// (get) Token: 0x06002C45 RID: 11333 RVA: 0x000C8ED8 File Offset: 0x000C70D8
		...
		// (get) Token: 0x06002C46 RID: 11334 RVA: 0x000C8EE9 File Offset: 0x000C70E9
		...
		// (get) Token: 0x06002C47 RID: 11335 RVA: 0x000C8EFA File Offset: 0x000C70FA
		...
		// (get) Token: 0x06002C48 RID: 11336 RVA: 0x000C8F0B File Offset: 0x000C710B
		...
		// (get) Token: 0x06002C49 RID: 11337 RVA: 0x000C8F1C File Offset: 0x000C711C
		...
		// (get) Token: 0x06002C4A RID: 11338 RVA: 0x000C8F2D File Offset: 0x000C712D
		...
		// (get) Token: 0x06002C4B RID: 11339 RVA: 0x000C8F3E File Offset: 0x000C713E
		...
		// (get) Token: 0x06002C4C RID: 11340 RVA: 0x000C8F4F File Offset: 0x000C714F
		...
		// (get) Token: 0x06002C4D RID: 11341 RVA: 0x000C8F60 File Offset: 0x000C7160
		...
		// (get) Token: 0x06002C4E RID: 11342 RVA: 0x000C8F71 File Offset: 0x000C7171
		...
		// (get) Token: 0x06002C4F RID: 11343 RVA: 0x000C8F82 File Offset: 0x000C7182
		...
		// (get) Token: 0x06002C50 RID: 11344 RVA: 0x000C8F93 File Offset: 0x000C7193
		...
		// (get) Token: 0x06002C51 RID: 11345 RVA: 0x000C8FA4 File Offset: 0x000C71A4
		...
		// (get) Token: 0x06002C52 RID: 11346 RVA: 0x000C8FB5 File Offset: 0x000C71B5
		...
		// (get) Token: 0x06002C53 RID: 11347 RVA: 0x000C8FC6 File Offset: 0x000C71C6
		...
		// (get) Token: 0x06002C54 RID: 11348 RVA: 0x000C8FD7 File Offset: 0x000C71D7
		...
		// (get) Token: 0x06002C55 RID: 11349 RVA: 0x000C8FE8 File Offset: 0x000C71E8
		...
		// (get) Token: 0x06002C56 RID: 11350 RVA: 0x000C8FF9 File Offset: 0x000C71F9
		...
		// (get) Token: 0x06002C57 RID: 11351 RVA: 0x000C900A File Offset: 0x000C720A
		...
		// (get) Token: 0x06002C58 RID: 11352 RVA: 0x000C901B File Offset: 0x000C721B
		...
		// (get) Token: 0x06002C59 RID: 11353 RVA: 0x000C902C File Offset: 0x000C722C
		...
		// (get) Token: 0x06002C5A RID: 11354 RVA: 0x000C903D File Offset: 0x000C723D
		...
		// (get) Token: 0x06002C5B RID: 11355 RVA: 0x000C904E File Offset: 0x000C724E
		...
		// (get) Token: 0x06002C5C RID: 11356 RVA: 0x000C905F File Offset: 0x000C725F
		...
		// (get) Token: 0x06002C5D RID: 11357 RVA: 0x000C9070 File Offset: 0x000C7270
		...
		// (get) Token: 0x06002C5E RID: 11358 RVA: 0x000C9081 File Offset: 0x000C7281
		...
		// (get) Token: 0x06002C5F RID: 11359 RVA: 0x000C9092 File Offset: 0x000C7292
		...
		// (get) Token: 0x06002C60 RID: 11360 RVA: 0x000C90A3 File Offset: 0x000C72A3
		...
		// (get) Token: 0x06002C61 RID: 11361 RVA: 0x000C90B4 File Offset: 0x000C72B4
		...
		// (get) Token: 0x06002C62 RID: 11362 RVA: 0x000C90C5 File Offset: 0x000C72C5
		...
		// (get) Token: 0x06002C63 RID: 11363 RVA: 0x000C90D6 File Offset: 0x000C72D6
		...
		// (get) Token: 0x06002C64 RID: 11364 RVA: 0x000C90E7 File Offset: 0x000C72E7
		...
		// (get) Token: 0x06002C65 RID: 11365 RVA: 0x000C90F8 File Offset: 0x000C72F8
		...
		// (get) Token: 0x06002C66 RID: 11366 RVA: 0x000C9109 File Offset: 0x000C7309
		...
		// (get) Token: 0x06002C67 RID: 11367 RVA: 0x000C911A File Offset: 0x000C731A
		...
		// (get) Token: 0x06002C68 RID: 11368 RVA: 0x000C912B File Offset: 0x000C732B
		...
		// (get) Token: 0x06002C69 RID: 11369 RVA: 0x000C913C File Offset: 0x000C733C
		...
		// (get) Token: 0x06002C6A RID: 11370 RVA: 0x000C914D File Offset: 0x000C734D
		...
		// (get) Token: 0x06002C6B RID: 11371 RVA: 0x000C915E File Offset: 0x000C735E
		...
		// (get) Token: 0x06002C6C RID: 11372 RVA: 0x000C916F File Offset: 0x000C736F
		...
		// (get) Token: 0x06002C6D RID: 11373 RVA: 0x000C9180 File Offset: 0x000C7380
		...
		// (get) Token: 0x06002C6E RID: 11374 RVA: 0x000C9191 File Offset: 0x000C7391
		...
		// (get) Token: 0x06002C6F RID: 11375 RVA: 0x000C91A2 File Offset: 0x000C73A2
		...
		// (get) Token: 0x06002C70 RID: 11376 RVA: 0x000C91B3 File Offset: 0x000C73B3
		...
		// (get) Token: 0x06002C71 RID: 11377 RVA: 0x000C91C4 File Offset: 0x000C73C4
		...
		// (get) Token: 0x06002C72 RID: 11378 RVA: 0x000C91D5 File Offset: 0x000C73D5
		...
		// (get) Token: 0x06002C73 RID: 11379 RVA: 0x000C91E6 File Offset: 0x000C73E6
		...
		// (get) Token: 0x06002C74 RID: 11380 RVA: 0x000C91F7 File Offset: 0x000C73F7
		...
		// (get) Token: 0x06002C75 RID: 11381 RVA: 0x000C9208 File Offset: 0x000C7408
		...
		// (get) Token: 0x06002C76 RID: 11382 RVA: 0x000C9219 File Offset: 0x000C7419
		...
		// (get) Token: 0x06002C77 RID: 11383 RVA: 0x000C922A File Offset: 0x000C742A
		...
		// (get) Token: 0x06002C78 RID: 11384 RVA: 0x000C923B File Offset: 0x000C743B
		...
		// (get) Token: 0x06002C79 RID: 11385 RVA: 0x000C924C File Offset: 0x000C744C
		...
		// (get) Token: 0x06002C7A RID: 11386 RVA: 0x000C925D File Offset: 0x000C745D
		...
		// (get) Token: 0x06002C7B RID: 11387 RVA: 0x000C926E File Offset: 0x000C746E
		...
		// (get) Token: 0x06002C7C RID: 11388 RVA: 0x000C927F File Offset: 0x000C747F
		...
		// (get) Token: 0x06002C7D RID: 11389 RVA: 0x000C9290 File Offset: 0x000C7490
		...
		// (get) Token: 0x06002C7E RID: 11390 RVA: 0x000C92A1 File Offset: 0x000C74A1
		...
		// (get) Token: 0x06002C7F RID: 11391 RVA: 0x000C92B2 File Offset: 0x000C74B2
		...
		// (get) Token: 0x06002C80 RID: 11392 RVA: 0x000C92C3 File Offset: 0x000C74C3
		...
		// (get) Token: 0x06002C81 RID: 11393 RVA: 0x000C92D4 File Offset: 0x000C74D4
		...
		// (get) Token: 0x06002C82 RID: 11394 RVA: 0x000C92E5 File Offset: 0x000C74E5
		...
		// (get) Token: 0x06002C83 RID: 11395 RVA: 0x000C92F6 File Offset: 0x000C74F6
		...
		// (get) Token: 0x06002C84 RID: 11396 RVA: 0x000C9307 File Offset: 0x000C7507
		...
		// (get) Token: 0x06002C85 RID: 11397 RVA: 0x000C9318 File Offset: 0x000C7518
		...
		// (get) Token: 0x06002C86 RID: 11398 RVA: 0x000C9329 File Offset: 0x000C7529
		...
		// (get) Token: 0x06002C87 RID: 11399 RVA: 0x000C933A File Offset: 0x000C753A
		...
		// (get) Token: 0x06002C88 RID: 11400 RVA: 0x000C934B File Offset: 0x000C754B
		...
		// (get) Token: 0x06002C89 RID: 11401 RVA: 0x000C935C File Offset: 0x000C755C
		...
		// (get) Token: 0x06002C8A RID: 11402 RVA: 0x000C936D File Offset: 0x000C756D
		...
		// (get) Token: 0x06002C8B RID: 11403 RVA: 0x000C937E File Offset: 0x000C757E
		...
		// (get) Token: 0x06002C8C RID: 11404 RVA: 0x000C938F File Offset: 0x000C758F
		...
		// (get) Token: 0x06002C8D RID: 11405 RVA: 0x000C93A0 File Offset: 0x000C75A0
		...
		// (get) Token: 0x06002C8E RID: 11406 RVA: 0x000C93B1 File Offset: 0x000C75B1
		...
		// (get) Token: 0x06002C8F RID: 11407 RVA: 0x000C93C2 File Offset: 0x000C75C2
		...
		// (get) Token: 0x06002C90 RID: 11408 RVA: 0x000C93D3 File Offset: 0x000C75D3
		...
		// (get) Token: 0x06002C91 RID: 11409 RVA: 0x000C93E4 File Offset: 0x000C75E4
		...
		// (get) Token: 0x06002C92 RID: 11410 RVA: 0x000C93F5 File Offset: 0x000C75F5
		...
		// (get) Token: 0x06002C93 RID: 11411 RVA: 0x000C9406 File Offset: 0x000C7606
		...
		// (get) Token: 0x06002C94 RID: 11412 RVA: 0x000C9417 File Offset: 0x000C7617
		...
		// (get) Token: 0x06002C95 RID: 11413 RVA: 0x000C9428 File Offset: 0x000C7628
		...
		// Token: 0x06002C96 RID: 11414 RVA: 0x000C943C File Offset: 0x000C763C
