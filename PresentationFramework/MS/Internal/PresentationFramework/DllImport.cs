...
namespace MS.Internal.PresentationFramework
{
	...
	internal static class DllImport
	{
		...
		internal const string PresentationNative = "PresentationNative_v0400.dll";

		// Token: 0x04003B2D RID: 15149
		internal const string PresentationCFFRasterizerNative = "PresentationCFFRasterizerNative_v0400.dll";

		// Token: 0x04003B2E RID: 15150
		internal const string MilCore = "wpfgfx_v0400.dll";
